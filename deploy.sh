...
BACKEND_IMAGE="axiom-lcel-rag-backend"
FRONTEND_IMAGE="axiom-lcel-rag-frontend"
TAG="latest"

# Exit immediately if a command fails
set -e

echo "🚀 Starting Deployment for Axiom Stack..."
...
docker build -t $DOCKER_USER/$BACKEND_IMAGE:$TAG ./agent
